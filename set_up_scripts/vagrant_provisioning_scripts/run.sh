...
sh /vagrant/set_up_scripts/vagrant_provisioning_scripts/set_up_python.sh
...
echo "Installing Virtualenv environment for python"
sh /vagrant/set_up_scripts/vagrant_provisioning_scripts/set_up_working_env.sh
